...
func BuildServerTLS(serverCertFile, serverKeyFile, caFile, prevCaFile string, nextProtos []string, clientAuth tls.ClientAuthType, isArpc bool) (*tls.Config, error) {
