...
var alertsPanel = js.Panel{
	...
	Tbar: []js.Tool{
		{Text: "Edit", Handler: "editAlert", Disabled: true, EnableFn: enableOnSingleSelection}, js.Sep(),
			...
			js.Panel{
				...
				Items: js.Items(js.Panel{
					...
					Tbar: []js.Tool{
						...
						{XType: js.XButton, Text: "Remove", IconCls: "fa fa-trash-o", Handler: "removeExclusion", Disabled: true, EnableFn: enableOnSelection}, js.Sep(),
