...
var verificationPanel = js.Panel{
	...
	Controller: js.Controller{Methods: map[string]js.Raw{
		"onSearchKeyUp":      js.SearchFilter("id", "backup_job_id", "ns", "mode", "comment"),
		"addJob":             js.OpenEditWindow("PBS.D2DVerification.JobEdit", ""),
		"editJob":            js.EditJobWindow("PBS.D2DVerification.JobEdit"),
		"removeJobs":         js.ConfirmRemove("/api2/extjs/config/d2d-verification/", "encodePathValue(rec.getId())", "Remove selected verification jobs?"),
		"runJobs":            js.RunJobs(verificationRunURL, "Start verification job '{0}'?", "Start verification jobs '{0}'?"),
	...
	Tbar: []js.Tool{
		js.AddJobTool,
		{Text: "Edit Job", Handler: "editJob", Disabled: true, EnableFn: js.EnableOnSingleSelection},
		{Text: "Remove Job(s)", Handler: "removeJobs", Disabled: true, EnableFn: js.EnableOnSelection}, js.Sep(),
		{Text: "Run Job(s)", Handler: "runJobs", Disabled: true, EnableFn: js.EnableOnSelection},
		js.StopJobsTool,
		{Text: "Show Results", Handler: "showResults", Disabled: true, EnableFn: js.EnableOnSingleSelection}, js.Sep(),
