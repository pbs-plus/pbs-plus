...
var mtfInventoryPanel = js.Panel{
	...
	Tbar: []js.Tool{
		...
		{Text: "Migrate Cartridge", Handler: "migrateCartridge", Disabled: true, EnableFn: enableOnRecord},
		{Text: "Migrate Set", Handler: "migrateFamily", Disabled: true, EnableFn: enableOnRecord},
	},
	Columns: []js.Column{
