...
var mtfJobPanel = js.Panel{
	...
	Tbar: []js.Tool{
		...
		{Text: "Edit", Handler: "editJob", Disabled: true, EnableFn: enableOnRecord},
		{Text: "Remove", Handler: "removeJobs", Disabled: true, EnableFn: enableOnRecord}, js.Sep(),
		{Text: "Run now", Handler: "runJob", Disabled: true, EnableFn: enableOnRecord},
