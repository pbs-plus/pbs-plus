...
var models = []js.Value{
	js.Model{
		...
		Fields: js.Typed(js.Fields(
			...
			"database_scope", "database_name", "database_client_family", "database_client_dir",
		), "stale", "bool"),
		IDProperty: "id",
	...
	js.Model{
		...
		Fields: js.Fields(
			...
			"database_ca_certificate", "database_default_client_dir", "database_variant",
			"database_default_client_family",
		),
		IDProperty: "name",
	},
	js.Model{
