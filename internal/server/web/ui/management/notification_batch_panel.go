...
var notificationBatchPanel = js.Panel{
	...
	Tbar: []js.Tool{
		...
		{Text: "Edit Batch", Handler: "editBatch", Disabled: true, EnableFn: js.EnableOnSingleSelection},
		{Text: "Remove", Handler: "removeBatches", Disabled: true, EnableFn: js.EnableOnSelection},
	},
	Columns: []js.Column{
