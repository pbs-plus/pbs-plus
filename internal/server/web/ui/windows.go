...
var windows = []js.Value{
	js.EditWindow{
		...
		CBindData: pathKeyedURL("/api2/extjs/config/d2d-exclusion"),
		Items: js.Items(
	...
	js.EditWindow{
		...
		CBindData: pathKeyedURL("/api2/extjs/config/d2d-token"),
		Items: js.Items(
	...
	js.EditWindow{
		...
		CBindData: pathKeyedURL("/api2/extjs/config/d2d-target"),
		Items: js.Items(
