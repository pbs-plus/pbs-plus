...
var tokenPanel = js.Panel{
	...
	Controller: js.Controller{Methods: map[string]js.Raw{
		"onAdd":             openEditWindow("PBS.D2DManagement.TokenEditWindow", ""),
		"onCopy":            copySelectionWindow("Bootstrap Token", "token"),
		"onDeploy":          copySelectionWindow("Deployment Scripts", "win_install"),
		"onShowFingerprint": showFingerprint,
		"revokeTokens":      confirmRemove("/api2/extjs/config/d2d-token/", "encodePathValue(rec.getId())", "Revoke selected tokens?"),
	...
	Tbar: []js.Tool{
		...
		{Text: "Revoke Token", Handler: "revokeTokens", Disabled: true, EnableFn: enableOnSelection},
	},
	Columns: []js.Column{
