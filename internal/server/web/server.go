...
func NewServer(app *application.Runtime, version string) (*Server, error) {
	...
	apiMux.HandleFunc("/api2/json/d2d/database-clients", ServerOnly(app, targetapi.D2DDatabaseClientsHandler()))
	...
	apiMux.HandleFunc("/api2/extjs/config/d2d-plugin-repository/{repository}/refresh", ServerOnly(app, targetapi.ExtJsPluginRepositoryRefreshHandler(app)))
	apiMux.HandleFunc("/api2/extjs/config/d2d-installed-plugin", ServerOnly(app, targetapi.ExtJsInstalledPluginsHandler(app)))
	apiMux.HandleFunc("/api2/extjs/config/d2d-installed-plugin/{plugin}", ServerOnly(app, targetapi.ExtJsInstalledPluginHandler(app)))
	apiMux.HandleFunc("/api2/extjs/config/d2d-installed-plugin/{plugin}/{version}", ServerOnly(app, targetapi.ExtJsInstalledPluginVersionHandler(app)))
	apiMux.HandleFunc("/api2/extjs/config/d2d-installed-plugin/{plugin}/{version}/activate", ServerOnly(app, targetapi.ExtJsInstalledPluginVersionActivateHandler(app)))
	apiMux.HandleFunc("/api2/extjs/config/d2d-installed-plugin/{plugin}/{version}/health", ServerOnly(app, targetapi.ExtJsInstalledPluginVersionHealthHandler(app)))
	apiMux.HandleFunc("/api2/extjs/config/d2d-plugin-install", ServerOnly(app, targetapi.ExtJsPluginInstallHandler(app)))
	...
	apiMux.HandleFunc("/api2/extjs/config/d2d-target/{target}/database-password", ServerOnly(app, targetapi.ExtJsTargetDatabasePasswordHandler(app)))
